...
//   MAIN_WEBSITE_BASE_URL: 'https://rebrivo-website.netlify.app',
//   DASHBOARD_BASE_URL: 'https://rebrivo-seller-dashboard.netlify.app',
// };
...
export const config = {
  ...
  MAIN_WEBSITE_BASE_URL: () => {
    if (typeof window === 'undefined') {
      return 'https://rebrivo.vercel.app/'; // Default for SSR
    }
  ...
  DASHBOARD_BASE_URL: () => {
    if (typeof window === 'undefined') {
      return 'https://rebrivo-seller.vercel.app'; // Default for SSR
    }
    return window.location.hostname === 'localhost' || window.location.hostname === '127.0.0.1'
      ? 'http://localhost:3001'
      : 'https://rebrivo-seller.vercel.app'; // Updated to new hosted URL
  },
};
